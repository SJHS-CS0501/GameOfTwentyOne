...
public class GameOfTwentyOne {
	...
	public static void main(String[] args) {
		...
		c.fill = GridBagConstraints.BOTH; // what to do when the component's
											// display area is larger than the
		 ...
		 * 
		 * Before this was added, my first roll statement (You rolled an _!)
		 * would write over itself..this is to fix that. In the actionReader, I
		 * have "label.setVisible(false);" this is making the second roll
		 * statement (You rolled an _ !) disappear before it prints the next
		 * one.
		 * 
		 * So this label is holding that space for the first roll statement..so
		 * I could write "die.setVisible(false)" so before prints the next roll
		 * statement the previous one disappears
		 * 
		 * I understand this is confusing, and bad programming.. I can go back
		 * and change it later and make it more efficient
		 */
		die = new JLabel("");
		frame.add(die, c);
		...
		/*
		 * what to do when the component's display area is larger than the
		 * component's requested size
		 */
	...
	static class Listener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (eventSource.getText().equals("No")) {
				...
				// both player's totals < 21, but computer's total is closer to
				// 21
